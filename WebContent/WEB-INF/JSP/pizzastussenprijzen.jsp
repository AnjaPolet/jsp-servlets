...
<label>Van prijs<span>${fouten.van}</span><input name='van' autofocus></label>
<label>Tot prijs<span>${fouten.tot}</span><input name='tot'></label>
...
<div class='fout'>Geen pizza's gevonden</div></c:if>
</body>
</html>